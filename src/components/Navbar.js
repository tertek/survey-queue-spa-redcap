                        ...
                        <div className="relative flex items-center justify-between h-16">
                          ...
                          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                            <div className="flex-shrink-0 flex items-center">
                              ...
                              <div className="text-white ml-5 font-sans text-lg antialiased font-medium tracking-wide leading-normal uppercase">STPH - %Project Name%</div>
                            </div>
                            <div className="hidden sm:block sm:ml-6">
                              <div className="flex space-x-4 ml-4">
                                ...
                                <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">News</a>
                              </div>
                            </div>
                          </div>
